		...
		if(exports.stats)
		{
			...
			else
			{
				...
				if(envData.cmd === 'g++')
				{
					...
					//compile c code
					commmand = 'cd ./temp/ && g++ -o '+filename +" "+ filename +'.cpp';
							...
							if(input){
								...
								fs.writeFile( path  +  inputfile , input  , function(err ){
									...
									var temp="cd temp & "+filename+".out";
										exec( temp  + ' < ' + inputfile , function( error , stdout , stderr ){
									if(error)
									{
							...
							if(input){
								...
								fs.writeFile( path  +  inputfile , input  , function(err ){
									if(exports.stats)
									{
										...
										console.log('INFO: '.green + inputfile +' (inputfile) created');
										exec('cd '+ path +' && '+ filename +'.out' + ' < ' + inputfile , function( error , stdout , stderr ){
									if(error)
									{
